class LocalizeTags {
  public static readonly pingReply = 'pingReply';
  public static readonly avatarTitle = 'avatarTitle';
  public static readonly avatarDescription = 'avatarDescription';
  public static readonly rollReply = 'rollReply';
